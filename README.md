# @diotoborg/assumenda-rem-iure
A tool for JSON parse and stringify by stream and web worker.

![language](https://img.shields.io/badge/language-JavaScript-orange.svg) 
[![npm version](http://img.shields.io/npm/v/@diotoborg/assumenda-rem-iure.svg?style=flat)](https://npmjs.org/package/@diotoborg/assumenda-rem-iure) 
[![license](https://img.shields.io/npm/l/@diotoborg/assumenda-rem-iure.svg?style=flat)](https://npmjs.org/package/@diotoborg/assumenda-rem-iure) 
[![gzip file size](http://img.badgesize.io/yuda-lyu/@diotoborg/assumenda-rem-iure/master/dist/@diotoborg/assumenda-rem-iure.umd.js.svg?compression=gzip)](https://github.com/diotoborg/assumenda-rem-iure)
[![npm download](https://img.shields.io/npm/dt/@diotoborg/assumenda-rem-iure.svg)](https://npmjs.org/package/@diotoborg/assumenda-rem-iure) 
[![npm download](https://img.shields.io/npm/dm/@diotoborg/assumenda-rem-iure.svg)](https://npmjs.org/package/@diotoborg/assumenda-rem-iure)
[![jsdelivr download](https://img.shields.io/jsdelivr/npm/hm/@diotoborg/assumenda-rem-iure.svg)](https://www.jsdelivr.com/package/npm/@diotoborg/assumenda-rem-iure)

## Documentation
To view documentation or get support, visit [docs](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/global.html).

## Installation
### Using npm(ES6 module):
> **Note:** @diotoborg/assumenda-rem-iure is mainly dependent on `from2` and `jsonparse`.
```alias
npm i @diotoborg/assumenda-rem-iure
```

#### Example for samll data:
> **Link:** [[dev source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/g-small.mjs)]
```alias
...
#### Example for stream:
> **Link:** [[dev source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/g-stream.mjs)]
```alias
...
> **stringify and parse for small data:** [ex-small.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-small.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-small.html)]

> **stringifyByStream and parseByStream for small data:** [ex-small-stream.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-small-stream.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-small-stream.html)]

> **stringify and parse for large data:** [ex-large.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-large.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-large.html)]

> **createParseStream:** [ex-stream-createParseStream.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-stream-createParseStream.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-stream-createParseStream.html)] * ReadableStream does not support IE11.

> **createParseStream with filter:** [ex-stream-createParseStreamWithFilter.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-stream-createParseStreamWithFilter.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-stream-createParseStreamWithFilter.html)]

> **createStringifyStream:** [ex-stream-createStringifyStream.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-stream-createStringifyStream.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-stream-createStringifyStream.html)] * WritableStream does not support IE11 and Firefox.

> **stringify and parse for large data in web worker:** [ex-large-webworker.html](https://yuda-lyu.github.io/@diotoborg/assumenda-rem-iure/examples/ex-large-webworker.html) [[source code](https://github.com/diotoborg/assumenda-rem-iure/blob/master/docs/examples/ex-large-webworker.html)] * WebWorkers(from blob) does not support IE11.
```alias

console.log('WebWorkers(from blob) does not support IE11')

let json = window['@diotoborg/assumenda-rem-iure']
console.log(json)
